...
public interface VisitSchedulerDAO extends JpaDao<VisitScheduler> {
     ...
     *
     */
    public Set<VisitScheduler> findAllVisitSchedulers(int startResult, int maxRows)
     ...
     *
     */
    public Set<VisitScheduler> findVisitSchedulerByNumberOfDay(Integer numberOfDay)
	    throws DataAccessException;
     ...
     *
     */
    public Set<VisitScheduler> findVisitSchedulerByNumberOfMonth(Integer numberOfMonth)
	    throws DataAccessException;
     ...
     *
     */
    public Set<VisitScheduler> findVisitSchedulerByTimeOfVisit(java.util.Calendar timeOfVisit)
	    throws DataAccessException;
     ...
     *
     */
    public Set<VisitScheduler> findVisitSchedulerByTimeOfVisit(Calendar timeOfVisit,
	    int startResult, int maxRows) throws DataAccessException;
     ...
     *
     */
    public VisitScheduler findVisitSchedulerById(Integer id, int startResult, int maxRows)
	    throws DataAccessException;
     ...
     *
     */
    public VisitScheduler findVisitSchedulerByPrimaryKey(Integer id_1, int startResult, int maxRows)
	    throws DataAccessException;
