...
public interface ReportDAO extends JpaDao<Report> {
	 ...
	 *
	 */
	public Set<Report> findReportByDateFromBefore(Calendar dateFrom, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Report> findReportByDateToBefore(Calendar dateTo, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateFromAfter
	 *
	 */
	public Set<Report> findReportByDateFromAfter(java.util.Calendar dateFrom_1) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateFromAfter
	 *
	 */
	public Set<Report> findReportByDateFromAfter(Calendar dateFrom_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateFrom
	 *
	 */
	public Set<Report> findReportByDateFrom(java.util.Calendar dateFrom_2) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateFrom
	 *
	 */
	public Set<Report> findReportByDateFrom(Calendar dateFrom_2, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Report> findReportByDateToAfter(java.util.Calendar dateTo_1) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateToAfter
	 *
	 */
	public Set<Report> findReportByDateToAfter(Calendar dateTo_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Report> findReportByDateTo(java.util.Calendar dateTo_2) throws DataAccessException;

	/**
	 * JPQL Query - findReportByDateTo
	 *
	 */
	public Set<Report> findReportByDateTo(Calendar dateTo_2, int startResult, int maxRows) throws DataAccessException;
