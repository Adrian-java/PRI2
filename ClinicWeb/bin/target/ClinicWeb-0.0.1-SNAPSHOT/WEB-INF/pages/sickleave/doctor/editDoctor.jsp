...
<html>
<head>
<title>Edit <fmt:message key="sickleave.title"/> <fmt:message key="doctor.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSickLeaveDoctor" method="POST" modelAttribute="doctor">
