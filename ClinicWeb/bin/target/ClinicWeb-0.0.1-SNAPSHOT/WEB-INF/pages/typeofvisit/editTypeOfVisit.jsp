...
<html>
<head>
<title>Edit <fmt:message key="typeofvisit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveTypeOfVisit" method="POST" modelAttribute="typeofvisit">
