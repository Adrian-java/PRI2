...
<html>
<head>
<title>Edit <fmt:message key="statusofvisit.title"/> <fmt:message key="visit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveStatusOfVisitVisits" method="POST" modelAttribute="visit">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="statusofvisit_id" value="${statusofvisit_id}" >
