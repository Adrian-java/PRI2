...
<html>
<head>
<title>Edit <fmt:message key="patient.title"/> <fmt:message key="recipe.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientRecipes" method="POST" modelAttribute="recipe">
