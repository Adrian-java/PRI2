...
<html>
<head>
<title>Edit <fmt:message key="patient.title"/> <fmt:message key="address.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientAddress" method="POST" modelAttribute="address">
