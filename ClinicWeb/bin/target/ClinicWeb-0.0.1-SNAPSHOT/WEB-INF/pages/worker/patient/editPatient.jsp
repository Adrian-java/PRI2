...
<html>
<head>
<title>Edit <fmt:message key="worker.title"/> <fmt:message key="patient.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveWorkerPatient" method="POST" modelAttribute="patient">
