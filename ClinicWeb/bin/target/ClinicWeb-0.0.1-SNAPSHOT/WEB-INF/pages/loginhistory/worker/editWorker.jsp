...
<html>
<head>
<title>Edit <fmt:message key="loginhistory.title"/> <fmt:message key="worker.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveLoginHistoryWorker" method="POST" modelAttribute="worker">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="loginhistory_id" value="${loginhistory_id}" >
