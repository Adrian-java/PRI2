...
<html>
<head>
<title>Edit <fmt:message key="admin.title"/> <fmt:message key="worker.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAdminWorkers" method="POST" modelAttribute="worker">
