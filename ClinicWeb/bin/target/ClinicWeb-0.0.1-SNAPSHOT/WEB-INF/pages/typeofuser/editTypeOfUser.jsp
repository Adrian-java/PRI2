...
<html>
<head>
<title>Edit <fmt:message key="typeofuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveTypeOfUser" method="POST" modelAttribute="typeofuser">
