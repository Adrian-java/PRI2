...
<html>
<head>
<title>Edit <fmt:message key="receptionist.title"/> <fmt:message key="visit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveReceptionistVisits" method="POST" modelAttribute="visit">
