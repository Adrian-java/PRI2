...
<html>
<head>
<title>Edit <fmt:message key="systemuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSystemUser" method="POST" modelAttribute="systemuser">
