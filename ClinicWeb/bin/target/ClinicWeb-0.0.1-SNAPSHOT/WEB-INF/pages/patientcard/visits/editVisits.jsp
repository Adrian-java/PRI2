...
<html>
<head>
<title>Edit <fmt:message key="patientcard.title"/> <fmt:message key="visit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientCardVisits" method="POST" modelAttribute="visit">
