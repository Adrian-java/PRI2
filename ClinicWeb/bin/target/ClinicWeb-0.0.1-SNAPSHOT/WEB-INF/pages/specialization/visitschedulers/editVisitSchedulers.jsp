...
<html>
<head>
<title>Edit <fmt:message key="specialization.title"/> <fmt:message key="visitscheduler.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSpecializationVisitSchedulers" method="POST" modelAttribute="visitscheduler">
