...
<html>
<head>
<title>Edit <fmt:message key="specialization.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSpecialization" method="POST" modelAttribute="specialization">
