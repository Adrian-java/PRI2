...
<html>
<head>
<title>Edit <fmt:message key="doctor.title"/> <fmt:message key="specialization.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDoctorSpecializations" method="POST" modelAttribute="specialization">
