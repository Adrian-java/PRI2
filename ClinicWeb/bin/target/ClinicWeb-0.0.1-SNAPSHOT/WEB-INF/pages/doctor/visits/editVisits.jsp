...
<html>
<head>
<title>Edit <fmt:message key="doctor.title"/> <fmt:message key="visit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDoctorVisits" method="POST" modelAttribute="visit">
