...
<html>
<head>
<title>Edit <fmt:message key="doctor.title"/> <fmt:message key="worker.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDoctorWorkers" method="POST" modelAttribute="worker">
