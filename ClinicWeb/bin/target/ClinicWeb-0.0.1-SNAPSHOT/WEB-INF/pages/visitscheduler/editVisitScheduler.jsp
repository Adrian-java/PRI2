...
<html>
<head>
<title>Edit <fmt:message key="visitscheduler.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVisitScheduler" method="POST" modelAttribute="visitscheduler">
