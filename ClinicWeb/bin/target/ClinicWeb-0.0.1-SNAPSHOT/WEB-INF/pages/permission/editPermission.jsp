...
<html>
<head>
<title>Edit <fmt:message key="permission.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePermission" method="POST" modelAttribute="permission">
