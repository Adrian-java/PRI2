...
<html>
<head>
<title>Edit <fmt:message key="specalvisitfield.title"/> <fmt:message key="specialization.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSpecalVisitFieldSpecialization" method="POST" modelAttribute="specialization">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="specalvisitfield_id" value="${specalvisitfield_id}" >
