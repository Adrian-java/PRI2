...
<html>
<head>
<title>Edit <fmt:message key="specalvisitfield.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSpecalVisitField" method="POST" modelAttribute="specalvisitfield">
