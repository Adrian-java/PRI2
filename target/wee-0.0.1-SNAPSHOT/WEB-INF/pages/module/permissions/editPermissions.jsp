...
<html>
<head>
<title>Edit <fmt:message key="module.title"/> <fmt:message key="permission.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveModulePermissions" method="POST" modelAttribute="permission">
