...
<html>
<head>
<title>View <fmt:message key="visitscheduler.title"/> <fmt:message key="specialization.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteVisitSchedulerSpecialization?visitscheduler_id=${visitscheduler_id}&related_specialization_id=${specialization.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
