...
<html>
<head>
<title>Edit <fmt:message key="recipe.title"/> <fmt:message key="doctor.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipeDoctor" method="POST" modelAttribute="doctor">
