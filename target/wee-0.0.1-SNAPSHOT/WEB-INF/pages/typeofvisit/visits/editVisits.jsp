...
<html>
<head>
<title>Edit <fmt:message key="typeofvisit.title"/> <fmt:message key="visit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveTypeOfVisitVisits" method="POST" modelAttribute="visit">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="typeofvisit_id" value="${typeofvisit_id}" >
