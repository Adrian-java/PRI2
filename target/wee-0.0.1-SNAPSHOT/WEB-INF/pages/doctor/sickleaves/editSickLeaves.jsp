...
<html>
<head>
<title>Edit <fmt:message key="doctor.title"/> <fmt:message key="sickleave.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDoctorSickLeaves" method="POST" modelAttribute="sickleave">
