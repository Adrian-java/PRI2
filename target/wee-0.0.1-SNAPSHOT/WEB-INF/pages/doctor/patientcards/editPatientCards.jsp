...
<html>
<head>
<title>Edit <fmt:message key="doctor.title"/> <fmt:message key="patientcard.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDoctorPatientCards" method="POST" modelAttribute="patientcard">
