...
<html>
<head>
<title>Edit <fmt:message key="address.title"/> <fmt:message key="patient.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAddressPatients" method="POST" modelAttribute="patient">
