...
<html>
<head>
<title>Edit <fmt:message key="systemuser.title"/> <fmt:message key="worker.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSystemUserWorker" method="POST" modelAttribute="worker">
