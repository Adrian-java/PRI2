...
<html>
<head>
<title>Edit <fmt:message key="worker.title"/> <fmt:message key="doctor.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveWorkerDoctor" method="POST" modelAttribute="doctor">
