...
<html>
<head>
<title>Edit <fmt:message key="worker.title"/> <fmt:message key="receptionist.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveWorkerReceptionist" method="POST" modelAttribute="receptionist">
