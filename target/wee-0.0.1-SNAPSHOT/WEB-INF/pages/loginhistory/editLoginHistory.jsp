...
<html>
<head>
<title>Edit <fmt:message key="loginhistory.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveLoginHistory" method="POST" modelAttribute="loginhistory">
