...
<html>
<head>
<title>Edit <fmt:message key="graphic.title"/> <fmt:message key="doctor.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveGraphicDoctor" method="POST" modelAttribute="doctor">
