...
<html>
<head>
<title>Edit <fmt:message key="statusofvisit.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveStatusOfVisit" method="POST" modelAttribute="statusofvisit">
