...
<html>
<head>
<title>Edit <fmt:message key="visit.title"/> <fmt:message key="doctor.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVisitDoctor" method="POST" modelAttribute="doctor">
