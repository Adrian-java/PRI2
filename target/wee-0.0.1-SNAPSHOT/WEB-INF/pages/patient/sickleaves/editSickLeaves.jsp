...
<html>
<head>
<title>Edit <fmt:message key="patient.title"/> <fmt:message key="sickleave.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientSickLeaves" method="POST" modelAttribute="sickleave">
