...
<html>
<head>
<title>Edit <fmt:message key="patient.title"/> <fmt:message key="patientcard.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientPatientCards" method="POST" modelAttribute="patientcard">
