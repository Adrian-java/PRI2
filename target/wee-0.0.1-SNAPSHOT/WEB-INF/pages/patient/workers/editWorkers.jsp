...
<html>
<head>
<title>Edit <fmt:message key="patient.title"/> <fmt:message key="worker.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientWorkers" method="POST" modelAttribute="worker">
