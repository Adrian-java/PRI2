...
<html>
<head>
<title>Edit <fmt:message key="patientcard.title"/> <fmt:message key="patient.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePatientCardPatient" method="POST" modelAttribute="patient">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="patientcard_id" value="${patientcard_id}" >
